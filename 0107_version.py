...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 21:36:41 2021
...
thisDate = datetime.date(2020, 9, 11)
while thisDate <= datetime.date(2020, 9, 11):
    ...
    mdOrderLog = db.read('md_order', start_date=thisDate_str, end_date=thisDate_str, symbol=[2300885])
    if mdOrderLog is None:
        thisDate = thisDate + datetime.timedelta(days=1)
        continue
    print(thisDate)
    mdTradeLog = db.read('md_trade', start_date=thisDate_str, end_date=thisDate_str, symbol=[2300885])
